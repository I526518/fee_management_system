...
class Stud_PD(models.Model):
    ...
    Added_by=models.ForeignKey(User,default=None,on_delete=models.PROTECT)
    Date_added=models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return self.USN
#--------------------------ADMISSION TYPES --------------------
class Adm_Types(models.Model):
    Diploma='Dip'
    CET='CET'
    Management='Mgmt'
    ChangeOfCollege='COC'
    ...
    Adm_Type=models.CharField(max_length=10,choices=Adm_Type_Choices,unique=True,default=CET)

    def __str__(self):
        return self.Adm_Type
#---------------------------COURSES LIST----------------------------------------
class Courses(models.Model):
    ...
    Course=models.CharField(max_length=10,choices=Course_Choices,unique=True,default=BE)

    def __str__(self):
        return self.Course
#--------------------------------QUOTA LIST --------------------
class Quota_List(models.Model):
    R='Rural'
    K='Kannada'
    HK='HK'
    N='None'
    ...
    Quota=models.CharField(max_length=10,choices=Quota_Choices,unique=True,default=N)
...
class Branches(models.Model):
    ...
    Branch=models.CharField(max_length=10,choices=Branch_Choices,unique=True,default=N)
...
class Fee_Str(models.Model):
    ...
    Adm_type=models.ForeignKey(Adm_Types,on_delete=models.CASCADE,default=None)
    Course=models.ForeignKey(Courses,on_delete=models.CASCADE,default=None)
    Quota=models.ForeignKey(Quota_List,on_delete=models.CASCADE,default=None)
    Branch=models.ForeignKey(Branches,on_delete=models.CASCADE,default=None)
    Apti_1=models.IntegerField(default=0)
    Tech_2=models.IntegerField(default=0)
    Book_3=models.IntegerField(default=0)
    IndP_4=models.IntegerField(default=0)
    IndV_5=models.IntegerField(default=0)
    Inte_6=models.IntegerField(default=0)
    Libr_7=models.IntegerField(default=0)
    Semi_8=models.IntegerField(default=0)
    Soft_9=models.IntegerField(default=0)
    Conf_10=models.IntegerField(default=0)
    Subj_11=models.IntegerField(default=0)
    Spor_12=models.IntegerField(default=0)
    Tran_13=models.IntegerField(default=0)
    Tuti_14=models.IntegerField(default=0)
    Volu_15=models.IntegerField(default=0)
...
class Stud_Admn(models.Model):
    ...
    Sid=models.OneToOneField(Stud_PD,on_delete=models.CASCADE)
    Course=models.ForeignKey(Courses,on_delete=models.CASCADE,default=None,)
    F=1
    S=2
    T=3
    ...
    Adm_Type=models.ForeignKey(Adm_Types,on_delete=models.CASCADE,default=None)
    Quota=models.ForeignKey(Quota_List,on_delete=models.CASCADE,default=None)
    Fid=models.ForeignKey(Fee_Str,on_delete=models.PROTECT,default=3)
...
class Faculty(models.Model):
    ...
    F_Designation=models.ForeignKey(F_Teach_Nonteach,on_delete=models.CASCADE)
    CS='CS'
    IS='IS'
    EC='EC'
    CV='CV'
